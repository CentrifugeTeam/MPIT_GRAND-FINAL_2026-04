    ...
    >
      ...
      >
        <button
          type='button'
          onClick={onClose}
          className='absolute right-4 top-5 z-10 flex size-8 cursor-pointer items-center justify-center rounded-3xl bg-surface transition-colors hover:bg-surface-secondary active:scale-[0.97]'
