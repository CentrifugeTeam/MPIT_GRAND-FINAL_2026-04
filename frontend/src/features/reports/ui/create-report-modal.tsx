      ...
      <Select.Popover>
        <ListBox>
          {dataSources.length === 0 ? (
            <ListBox.Item id="__empty" isDisabled textValue="—">
              —
            </ListBox.Item>
          ) : (
            dataSources.map((s) => (
              <ListBox.Item key={s.key} id={s.key} textValue={s.display_name}>
                {s.display_name}
  ...
  function datePicker(
    ...
    return (
      ...
      >
        ...
        <DateField.Group fullWidth className={fieldGroupCls}>
            ...
            <Modal.Dialog className="w-full max-w-xl rounded-3xl border border-zinc-800 bg-zinc-950 p-0 gap-0 shadow-none">
              <div className="flex flex-col gap-4 px-[17px] pb-[17px] pt-[9px]">
                ...
                >
                  ...
                  {/* Once */}
                  <Tabs.Panel id="once" className="flex flex-col gap-4 pt-4">
                    {dbSelect}
                  ...
                  {/* Daily */}
                  <Tabs.Panel id="daily" className="flex flex-col gap-4 pt-4">
                    {dbSelect}
                  ...
                  {/* Weekly */}
                  <Tabs.Panel id="weekly" className="flex flex-col gap-4 pt-4">
                    {dbSelect}
                    <div className="flex items-end gap-2">
                      {timeField}
                      <Select
                  ...
                  {/* Monthly */}
                  <Tabs.Panel id="monthly" className="flex flex-col gap-4 pt-4">
                    {dbSelect}
                    <div className="flex items-end gap-2">
                      {timeField}
                  ...
                  {/* Yearly */}
                  <Tabs.Panel id="yearly" className="flex flex-col gap-4 pt-4">
                    {dbSelect}
                    <div className="flex items-end gap-2">
                      {timeField}
                      {datePicker(
